...
public class SwipeUpAndStoreValuesBasedOnElementSwipe_IOS {
	...
	public static void main(String[] args) throws Throwable {
		...
		try {
			...
			caps.setCapability("appium:platformVersion", "17.5.1");
			caps.setCapability("appium:deviceName", "Ast");
			caps.setCapability("appium:automationName", "XCUITest");
			caps.setCapability("appium:udid", "00008110-000C45143C32401E");
			caps.setCapability("appium:bundleId", "com.google.Gmail");
	...
	public static HashSet swipeAndStoreValues(IOSDriver driver, HashSet<String> uniqueElements, String xpath,
