...
public class SliderIcon {
	public static void swipeSlider(AndroidDriver driver, int percentage) {
		// Locate the slider element
		WebElement slider = driver.findElement(By.xpath(
				"//android.widget.SeekBar[contains(@content-desc,'%')]"));
				// "//XCUIElementTypeStaticText[@name='Choose SIP Amount']/following-sibling::XCUIElementTypeOther")); // Update
		...
		System.out.println("Start X: " + startX + ", End X: " + endX + ", Target X for " + percentage + "%: " + targetX
				+ ", Center Y: " + centerY);
	 ...
	 * caps.setCapability("appium:platformVersion", "17.5.1"); // Update to match
	 * your iOS version caps.setCapability("appium:deviceName", "Ast");
	 * caps.setCapability("appium:automationName", "XCUITest"); // Path to your .app
	 * or .ipa file caps.setCapability("appium:udid", "00008110-000C45143C32401E");
	 * // Path to your .app or .ipa file
	 * 
	 * caps.setCapability("appium:bundleId", "com.google.Gmail"); // Path to your
	 * .app or .ipa file caps.setCapability("appium:agentPath",
